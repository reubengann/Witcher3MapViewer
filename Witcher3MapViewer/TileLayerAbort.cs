...
namespace Mapsui.Layers
{
    ...
    public class TileLayerAbort : BaseLayer, ITileLayer
    {
        ...
        public TileLayerAbort(Func<ITileSource> tileSourceInitializer) : this()
        {
            Task.Factory.StartNew(() => TileSource = tileSourceInitializer());
        }

        public TileLayerAbort(ITileSource source = null, int minTiles = 200, int maxTiles = 300, int maxRetries = TileFetcher.DefaultMaxAttempts,
